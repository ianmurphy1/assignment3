...
public class ManagerTest
{
	...
	public void testSettersAndGetters() {
		...
		assertEquals("Ned", m3.getFirstName());
		assertEquals("Stark", m3.getLastName());
	}
	...
	public void testSalary() {
		...
		//Test with employees
		m1.getMinions().get(0).calculateSalary(20);		
		assertEquals(369.95, m1.calculateSalary(15), DELTA);
		m1.getMinions().get(3).calculateSalary(16);	
		assertEquals(371.59, m1.calculateSalary(15), DELTA);
		
	    //Test @ 0 Hours worked
		assertEquals(0, m1.calculateSalary(0), DELTA);
		
		//Test without
		assertEquals(810, m2.calculateSalary(40), DELTA);
