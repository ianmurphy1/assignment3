...
public class SalesWorkerTest
{
	...
	public void testCalculateSalary() {
		...
		assertEquals(298.92, s1.calculateSalary(), DELTA);
		//Without OverTime
		s2.setHoursWorked(45);
		assertEquals(537.32, s2.calculateSalary(), DELTA);
		
		//Calc when hours is 0
		s1.setHoursWorked(0);
		assertEquals(0, s1.calculateSalary(), DELTA);
		
		//Calc When Bonus is 0
		s4.setHoursWorked(10);
		assertEquals(86, s4.calculateSalary(), DELTA);
	}
